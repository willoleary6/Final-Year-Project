...
class NeuralNet(object):
    ...
    def stochastic_gradient_decent(self, training_data,  mini_batch_size, learning_rate, test_data=None):
        ...
        if test_data:
            print("{0} / {1}".format(self.evaluate_neural_net_performance(test_data), new_test))
        else:
